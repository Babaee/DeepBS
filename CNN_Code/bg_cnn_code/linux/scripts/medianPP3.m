...
belief_root = '/usr/home/rez/ZM/Final_Work/tud-stadtmitte_seg';
out_root = '/usr/home/rez/ZM/Final_Work/tud-stadtmitte_seg_post';
           ...
           %     fprintf('video name #%d = %s\n', l, videos{l-2});
                try
                    ...
                    for i = 1:10000
                       ...
                       file_path =  [path_ '/' sprintf('bin%06d.png', i)];
                       im = im2double(imread(file_path));
                       im = medfilt2(im, [9 9]);
                       im = (im > R);
                         %im = padBg(file_path);  
                       out_path = [out_root '/' sprintf('bin%06d.png', i)];
