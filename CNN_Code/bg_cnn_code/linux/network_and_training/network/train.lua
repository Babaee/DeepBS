...
local dl_param = {
	h5_sequence = '/media/penn/data/FP_penn/Pre-process-in/training_data/data_SuBSENSE/', 
	sequence_stat = '/media/penn/data/FP_penn/Pre-process-in/training_data/data_SuBSENSE/stats/sequence_stat.h5' ,
	bg_stat = '/media/penn/data/FP_penn/Pre-process-in/training_data/data_SuBSENSE/stats/bg_stat.h5',
	start_train = 0, 
	stop_train = 149, 
	sequence_length = 170,
	batch_size = 150,
...
step = function()
	...
	while true do
	    ...
	    local feval = function(x_new)
	        ...
	        net:backward(mini_batch.data,gradients)
...
local output_folder = '/data/Background_Subtraction/CNN_Code/bg_cnn_code/linux/network_and_training/trained'
